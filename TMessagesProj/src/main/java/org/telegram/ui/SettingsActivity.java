...
public class SettingsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, PhotoViewer.PhotoViewerProvider {
    ...
    private int allowScreenshotSecretChatRow;
    ...
    public boolean onFragmentCreate() {
        ...
        allowScreenshotSecretChatRow = rowCount++;
    ...
    public View createView(Context context) {
        ...
        listView.setOnItemClickListener(new RecyclerListView.OnItemClickListener() {
            ...
            public void onItemClick(View view, final int position) {
                if (position == textSizeRow) {
                ...
                } else if (position == enableScreenshotDetectionRow) {
                    SharedPreferences preferences = ApplicationLoader.applicationContext.getSharedPreferences("mainconfig", Activity.MODE_PRIVATE);
                    ...
                    SharedPreferences preferences = ApplicationLoader.applicationContext.getSharedPreferences("mainconfig", Activity.MODE_PRIVATE);
                    boolean allowScreenshot = preferences.getBoolean("allow_screenshot_secret_chat", false);
                    SharedPreferences.Editor editor = preferences.edit();
                    editor.putBoolean("allow_screenshot_secret_chat", !allowScreenshot);
                    editor.commit();
                    if (view instanceof TextCheckCell) {
                        ((TextCheckCell) view).setChecked(!allowScreenshot);
                    }
    ...
    private class ListAdapter extends RecyclerView.Adapter {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            ...
            switch (holder.getItemViewType()) {
                ...
                case 4: {
                    ...
                    } else if (position == davidSettingsSectionRow2) {
                        ((HeaderCell) holder.itemView).setText(LocaleController.getString("DAVIDSETTINGS", R.string.DAVIDSETTINGS));
        ...
        public int getItemViewType(int position) {
            ...
            if (position == settingsSectionRow || position == davidSettingsSectionRow || position == supportSectionRow || position == messagesSectionRow || position == mediaDownloadSection || position == contactsSectionRow) {
                return 1;
            } else if (position == enableAnimationsRow || position == extraInfoSecretNotification || position == enableScreenshotDetectionRow || position == allowScreenshotSecretChatRow || position == sendByEnterRow || position == saveToGalleryRow || position == autoplayGifsRow || position == raiseToSpeakRow || position == customTabsRow || position == directShareRow) {
                return 3;
                ...
                return 6;
            } else if (position == settingsSectionRow2 || position == davidSettingsSectionRow2 || position == messagesSectionRow2 || position == supportSectionRow2 || position == numberSectionRow || position == mediaDownloadSection2) {
                return 4;
            } else {
                return 2;
            }
